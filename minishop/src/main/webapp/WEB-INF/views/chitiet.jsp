		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      ...
		      <ul class="nav navbar-nav navbar-right">
		      	<c:choose>
		      		<c:when test="${as!=null}">
		      			<li><a class="circle-avatar" href="http://localhost:8080/dangnhap"><span>${as }</span></a></li>
		      		</c:when>
		      		
		      		<c:otherwise>
		      			<li><a href="http://localhost:8080/dangnhap">ĐĂNG NHẬP</a></li>
		      		</c:otherwise>
		      	</c:choose>
		        <li id="giohang"><a href="http://localhost:8080/giohang"><img alt="icon-xe" src='<c:url value="/resource/Image/icon_google.png" />' />
					<c:choose>
