								...
								<ul class="nofitications-dropdown">
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
											   ...
											   <div class="user_img"><img alt="" src='<c:url value="/resource/template/images/in11.jpg" />' /></div>
											...
											<li class="odd"><a href="#">
												<div class="user_img"><img alt="" src='<c:url value="/resource/template/images/in10.jpg" />' /></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor </p>
												<p><span>1 hour ago</span></p>
												</div>
											...
											<li><a href="#">
											   <div class="user_img"><img alt="" src='<c:url value="/resource/template/images/in9.jpg" />' /></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
												<div class="user_img"><img alt="" src='<c:url value="/resource/template/images/in8.jpg" />' /></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li class="odd"><a href="#">
												<div class="user_img"><img alt="" src='<c:url value="/resource/template/images/in6.jpg" />' /></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li><a href="#">
												<div class="user_img"><img alt="" src='<c:url value="/resource/template/images/in7.jpg" />' /></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img alt="" src='<c:url value="/resource/template/images/in4.jpg" />' /></span> 
												<div class="user-name">
													<p>Malorum</p>
                                ...
                                <div class="card-body p-b-20">
                                    <div class="list-group">
                                        <a class="list-group-item media" href="">
                                             <div class="pull-left">
                                             	<img alt="lg-item-img" src='<c:url value="/resource/template/images/in1.jpg" />' />
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img alt="lg-item-img" src='<c:url value="/resource/template/images/in2.jpg" />' />
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img alt="lg-item-img" src='<c:url value="/resource/template/images/in3.jpg" />' />
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img alt="lg-item-img" src='<c:url value="/resource/template/images/in4.jpg" />' />
                                            </div>
                                            <div class="media-body">
                                            	<div class="pull-left">
